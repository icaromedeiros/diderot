...
class ExpectedFactsTestCase(DiderotTestCase):
    ...
    #    self.assert_that(can_infer(EXPECTED_FACTS_FILE).from_facts(EXPECTED_FACTS_FILE))

    #def test_check_expected_facts_unkown_protocol(self):
    #    EXPECTED_FACTS_URI = "ftp://www.uknown.com"
    #    self.assert_that(can_infer(EXPECTED_FACTS_URI).from_facts(EXPECTED_FACTS_URI))
    ...
    #    :Icaro a :Mortal ;
    #    """
    #    self.assert_that(can_infer(EXPECTED_FACTS_STRING).from_facts(EXPECTED_FACTS_STRING))
